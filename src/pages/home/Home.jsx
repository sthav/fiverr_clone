            ...
            <div className="features">
                <div className="container">
                    <div className="item">
                        ...
                        <p>Find high-quality servies at every price point. No hourly rates,
            ...
            <div className="features dark">
                <div className="container">
                    <div className="item">
                        ...
                        <p>Upgrade to a curated experience packed with ttools and benefits, dedicated
                            to businesses
                        </p>
                        <div className="title">
                            <img src="./img/check.png" alt="" />
                        ...
                        <div className="title">
                            <img src="./img/check.png" alt="" />
                            Manage teamwork and boost productivity with one powerfyl workspace
                        </div>
